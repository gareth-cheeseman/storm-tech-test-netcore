export const todoMediumImportanceGoldMark = `<li class="list-group-item undefined" data-isDone="false" >
  <div class="row">
    <div class="col-md-8">
      <a href="/TodoItem/Edit?todoItemId=1">Todo Medium Importance</a>
    </div>
