export const todoLowImportanceGoldMark = `<li class="list-group-item list-group-item-info" data-isDone="false" >
  <div class="row">
    <div class="col-md-8">
      <a href="/TodoItem/Edit?todoItemId=1">Todo Low Importance</a>
    </div>
